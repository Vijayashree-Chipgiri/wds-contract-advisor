...
function converseTyped() {
    ...
    if (document.getElementById('userInputTyped').value != "") {
       ...
       // var data = JSON.stringify({'message': $("#userInputTyped").val(), 'user_name':'Guest'})
        var data = JSON.stringify({'message': $("#userInputTyped").val(), 'user_name': login_user_ID})
        
        document.getElementById("conversation_wait").style.display="block";
        document.getElementById("userInputTyped").value = "bot is typing ...";
        document.getElementById("userInputTyped").disabled  = true;
        document.getElementById("userInputTyped").style.color = "red";
        ws.send(data);
        ...
        if(piMaskerFlag){
          var newReference = userinput.replace(/[a-zA-Z0-9]/g,"X");
          userinput = newReference;
        }
    ...
    var conversation_body = document.getElementById("conversation");
